...
# This is the class that is for the user to create an account and
# #create and index on the database storing the credentials
class User(UserMixin, db.Model):
    ...
    def check_password(self, password):
        # This will check if the provided password matches the stored password
